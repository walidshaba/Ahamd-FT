		...
		<section id="footer">
			<div class="inner">
				...
				<ul class="contact">
					...
					<li class="icon solid fa-envelope"><a href="mailto:ahmadabdullahi@gmail.com">ahmadabdullahi@gmail.com</a></li>
					<li class="icon brands fa-twitter"><a href="#">twitter.com</a></li>
					<li class="icon brands fa-facebook-f"><a href="#">facebook.com</a></li>
